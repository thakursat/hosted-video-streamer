...
echo ""
echo " Then open the app and create your account on the first visit"
echo " (the signup screen shows until an account exists)."
echo ""
echo " Prefer the CLI? Seed it instead:"
echo "   cd $APP_DIR"
